...
<!--
Magnetic forces do no work (use Griffiths, and watch that part of Adrian's magnetostatics 1 lecture more carefully)
In the lecture itself, use the force on a current-carrying wire to lead on to a discussion of the function of motors? 
--> 
## Practice problems
