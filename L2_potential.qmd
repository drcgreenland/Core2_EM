...
$$ V(r) = \frac{1}{4\pi \epsilon_0} \sum_{i} \frac{q_i}{\r_si} $$
...
$$ V(r) = \frac{1}{4\pi \epsilon_0} \int \frac{1}{\r_si} \mathrm{d}q $$
...
The electric field is related to the electric potential by the gradient: $\E = -\nabla V$. You can see a brief proof of this on page 77 of the Griffiths. This relationship implies that the electric field points in the direction of the greatest decrease of potential.
...
1) Consider a uniformly charges solid sphere of radius $R$ and total charge $q$. The electric field for this sphere is given by: 
...
2) In the worked example for Lecture 1 (see the lecture slides on Blackboard if you were not in attendance) we calculated the electric field a distance $z$ above the midpoint between two equal charges $q$ that are a distance $d$ apart. Now find the electric potential at a distance $z$ for these two charges. 
Check your answer by computing $\E = -\nabla V $.
...
3) 
(a) Find the electric field at a distance $z$ above the midpoint of a uniform line charge, of length $2L$ and charge density $\lambda$ (see figure below).

![](Figures/L2_prob3){width=200}

(b) Now find the potential at distance $z$ above the midpoint of the line charge. Check your answer by computing $\E = -\nabla V $. 
