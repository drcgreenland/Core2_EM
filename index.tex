...
Now repeat the calculation of the electric field, but replace one of the
positive charges with a negative charge (so we now have a dipole).
...
impossible one. For the \emph{possible} one, find the potential. Use the
...
\chapter{Lecture 3: Work and Energy in
Electrostatics}\label{lecture-3-work-and-energy-in-electrostatics}
...
square. Now, your task is to calculate the total work it takes to
assemble all 4 charges into the square configuration.

\bookmarksetup{startatroot}

\chapter{Lecture 4: Magnetic Fields and the Lorentz Force
Law}\label{lecture-4-magnetic-fields-and-the-lorentz-force-law}
...
\chapter{Lecture 5: The Biot-Savart Law - Magnetic Fields of
Currents}\label{lecture-5-the-biot-savart-law---magnetic-fields-of-currents}
...
\chapter{Lecture 6: Magnetic Vector
Potential}\label{lecture-6-magnetic-vector-potential}
...
\chapter{Lecture 7: Gauss's Law}\label{lecture-7-gausss-law}
...
\chapter{Lecture 8: Ampere's Law and
Solenoids}\label{lecture-8-amperes-law-and-solenoids}
...
\chapter{Lecture 9: Faraday's Law and Lenz's
Law}\label{lecture-9-faradays-law-and-lenzs-law}
...
\chapter{Lecture 10: Maxwell's Equations in Free
Space}\label{lecture-10-maxwells-equations-in-free-space}

\emph{Recommended reading}: Griffiths Section 7.3.1 - 7.3.4

\bookmarksetup{startatroot}

\chapter{Lecture 11: Magnetisation and
Polarisation}\label{lecture-11-magnetisation-and-polarisation}
...
\chapter{Lecture 12: Maxwell's Equations in
Matter}\label{lecture-12-maxwells-equations-in-matter}
...
\chapter{Lecture 12: Capacitors and
Inductors}\label{lecture-12-capacitors-and-inductors}
...
\chapter{Lecture 14: Circuits}\label{lecture-14-circuits}
...
\chapter{Lecture 15: Impedance}\label{lecture-15-impedance}
