...
\item
  ...
  positions ri\mathbf{r}\emph{iri, the total potential at a point
  r\mathbf{r}r is the sum of the potentials due to each charge:
  V(r)=ke∑iqi∣r−ri∣V(\mathbf{r}) = k\_e \sum}\{i\}
  \frac{q_i}{|\mathbf{r} - \mathbf{r}_i|}V(r)=ke∑i∣r−ri∣qi
\item
  Relationship Between Electric Field and Potential The electric field
  is related to the electric potential by the gradient: E=−∇V\mathbf{E}
...
\item
  ...
  uniform electric field E=E0x\^{}\mathbf{E} = E\_0
  \hat{\mathbf{x}}E=E0x\^{}, the potential difference between two points
  ...
  distribution with volume charge density ρ(r′)\rho(\mathbf{r'})ρ(r′),
  the electric potential at a point r\mathbf{r}r is:
  V(r)=ke∫ρ(r′)∣r−r′∣d3r′V(\mathbf{r}) = k\_e
...
\item
  ...
  sphere (r \textless{} R): V(r)=keQ2R(3−r2R2)V(r) = k\_e \frac{Q}{2R}
  \left( 3 - \frac{r^2}{R^2} \right)V(r)=ke2RQ(3−R2r2) • Outside the
  sphere (r \textgreater{} R): V(r)=keQrV(r) = k\_e \frac{Q}{r}V(r)=kerQ
  Example: Thin Spherical Shell For a thin spherical shell of radius RRR
  and total charge QQQ: • Inside the shell (r \textless{} R):
  V(r)=keQRV(r) = k\_e \frac{Q}{R}V(r)=keRQ • Outside the shell (r
  \textgreater{} R): V(r)=keQrV(r) = k\_e \frac{Q}{r}V(r)=kerQ
\item
...
\item
  ...
  U=12∑i≠jkeqiqjrijU = \frac{1}{2} \sum\emph{\{i \neq j\} k\_e
  \frac{q_i q_j}{r_{ij}}U=21∑i=jkerijqiqj where rijr}\{ij\}rij is the
  distance between charges qiq\_iqi and qjq\_jqj.
\item
  Energy Density of the Electric Field The energy density uuu of the
  electric field is: u=12ϵ0E2u = \frac{1}{2} \epsilon\_0 E\^{}2u=21ϵ0E2
  ...
  \frac{1}{2} \epsilon\_0 \int\_V E\^{}2 , d\^{}3rU=21ϵ0∫VE2d3r
\end{enumerate}
