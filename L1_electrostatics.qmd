...
# Lecture 1: Electrostatics - Charges, Forces & Fields
...
*A problem to try before attending the lecture*: Griffiths Problem 1.7
...
Now repeat the calculation of the electric field, but replace one of the positive charges with a negative charge (so we now have a dipole).